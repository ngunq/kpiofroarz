...
export class RevenueChartService {
  ...
  private getDataForWeekPeriod(): RevenueChart {
    return {
  ...
  private getDataForMonthPeriod(): RevenueChart {
    return {
  ...
  private getDataForYearPeriod(): RevenueChart {
    return {
  ...
  getRevenueChartData(period: string): RevenueChart {
